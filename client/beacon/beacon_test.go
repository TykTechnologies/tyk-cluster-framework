...
// This has been lifted from https://github.com/zeromq/gyre/blob/master/beacon/beacon_test.go
// for completeness. All credit to the zeromq/gyre team.
...
func TestBeacon(t *testing.T) {
	...
	if runtime.GOOS == "windows" {
		fmt.Println("Beacon tests skipped on windows")
		return
	}
